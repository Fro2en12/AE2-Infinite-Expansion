...
public final class AE2AddonConfig {
    ...
    public static final ModConfigSpec.IntValue IDLE_LANE_TARGET = BUILDER
    ...
    public static final ModConfigSpec.IntValue MAX_BATCH_COUNT = BUILDER
    ...
    public static final ModConfigSpec.LongValue BATCH_MAX_MULTIPLIER = BUILDER
    ...
    public static final ModConfigSpec.LongValue CHEAP_ORDER_AMOUNT = BUILDER
    ...
    /** 无限物品的显示字节数（纯外观） */
    public static final ModConfigSpec.LongValue CELL_DISPLAY_BYTES = BUILDER
    ...
    /** 无限物品的真实数量（提取/显示上限）。 */
    public static final ModConfigSpec.LongValue INFINITE_ITEM_AMOUNT = BUILDER
    ...
    public static final ModConfigSpec.LongValue CPU_DISPLAY_BYTES = BUILDER
    ...
    public static final ModConfigSpec.IntValue CPU_DISPLAY_THREADS = BUILDER
    ...
    public static final ModConfigSpec.LongValue FEEDER_STOCK_TARGET = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_FEED_BUDGET = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_FEED_STACK = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_RESTOCK_INTERVAL = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_EXTRACT_INTERVAL = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_EXTRACT_STACK = BUILDER
    ...
    public static final ModConfigSpec.IntValue FEEDER_EXTRACT_FLUID = BUILDER
    ...
    /** 主动抽取每次气体量（默认1000）。 */
    public static final ModConfigSpec.IntValue FEEDER_EXTRACT_GAS = BUILDER
    ...
    public static void register() {
        // NeoForge 21.1：registerConfig 从 ModLoadingContext 移到 ModContainer（FML 11）
