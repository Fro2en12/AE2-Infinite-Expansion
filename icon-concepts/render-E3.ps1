...
# smaller infinity band over the disk: centers (23,32)/(41,32), rout 13, rin 9.5 -> span x10..54 y19..45
for ($y=0;$y -lt 64;$y++){
  for ($x=0;$x -lt 64;$x++){
    $d=D2 $x $y 32 32
    ...
    $dL=D2 $x $y 23 32;$dR=D2 $x $y 41 32
    $inL=(($dL -le 13)-and($dL -gt 9.5));$inR=(($dR -le 13)-and($dR -gt 9.5))
    $inInf=$inL -or $inR
    $inKnot=([math]::Abs($x-32)+[math]::Abs($y-32) -le 2.4) -and ([math]::Abs($x-32)+[math]::Abs($y-32) -ge 1)
    $infc=$null
    if($inInf){
      if($y -lt 25){$infc=[System.Drawing.Color]::FromArgb(255,234,253,255)}
      elseif($y -lt 33){$infc=[System.Drawing.Color]::FromArgb(255,135,220,246)}
      elseif($y -lt 40){$infc=[System.Drawing.Color]::FromArgb(255,63,179,214)}
...
$canvas.Save("$OutDir\concept-E3-64.png",[System.Drawing.Imaging.ImageFormat]::Png)
...
$big.Save("$OutDir\concept-E3.png",[System.Drawing.Imaging.ImageFormat]::Png);$big.Dispose()
...
$bigSrc=[System.Drawing.Image]::FromFile("$OutDir\concept-E3.png")
$g16.DrawImage($bigSrc,0,0,16,16);$g16.Dispose()
$s16.Save("$OutDir\check-E3-16.png",[System.Drawing.Imaging.ImageFormat]::Png);$s16.Dispose()
...
$s16b=[System.Drawing.Image]::FromFile("$OutDir\check-E3-16.png")
$gB2.DrawImage($s16b,0,0,128,128);$gB2.Dispose()
$blow.Save("$OutDir\check-E3-16to128.png",[System.Drawing.Imaging.ImageFormat]::Png);$blow.Dispose()
